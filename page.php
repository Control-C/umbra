...
<div class="container">
    <textarea id="box1" class="box" rows="5" placeholder="Enter text here..." ></textarea>
   ...
   <!--   <button id="getAnswersButton" style="display:none;" onclick="processText()">Process Text</button> -->
     ...
     <div id="loading">
        ...
        <p>Loading local ML model, please wait... 230mb of puur AI Magic</p>
    </div>


    <box id="box2" class="box" rows="5" placeholder="Highlighted text will appear here..." ></box>

    <div class="buttons">
         <button  id="getAnswersButton" style="display:none;" onclick="replaceText(); processText();">Secure your prived data </button>
      
        <button id="getBlack-outButton" onclick="highlightText()" style="display:none;" > Black-out </button>
       <!--  GDPR data and know sensitive, or confidential information see how tool finds -->
      
    </div>
    <textarea id="box3" class="box hidden" rows="5" placeholder="Resulting text will appear here..." ></textarea>
    ...
    <div class="chatbot-container">
         <input  id="box3-prmpt" type="text" placeholder="Enter a prompt here">
         
          <button onclick=" send2api(); ">Send off to Gemini AI</button>
    </div>
  
       <textarea  id="box4" class="box hidden" rows="5" placeholder="API AI text will appear here..." readonly>  </textarea>
...
// });
    ...
    function highlightText() {
       ...
       // document.getElementById('box1').innerHTML = highlightedText;
    }
    ...
    document.getElementById('getBlack-outButton').style.display = 'block'; 
    ...
    function  send2api(){
        ...
        const apiUrl = `send_promt.php?prompt=${encodedX}&key=<?php 
